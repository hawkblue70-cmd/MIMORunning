...
struct RunSummaryTests {
    ...
    @Test func hrvEvidenceAppendsSevenDayAndBaseline() {
        ...
        #expect(lines(i)[3].evidence?.hasSuffix("\nHRV 7일 평균 37(보통) · 4주 평균 30ms") == true)
        inEnglish { #expect(lines(i)[3].evidence?.hasSuffix("\nHRV 7-day avg 37 (normal) · 4-wk avg 30ms") == true) }
    }
    ...
    @Test func hrvEvidenceGradeFollowsTrend() {
        ...
        #expect(lines(i)[3].evidence?.contains("7일 평균 37(좋음)") == true)
        i.hrvTrend = hrv(.below)
        #expect(lines(i)[3].evidence?.contains("7일 평균 37(낮음)") == true)
        i.hrvTrend = hrv(.above, volatile: true)
        #expect(lines(i)[3].evidence?.contains("7일 평균 37(불안정)") == true)
        ...
        #expect(lines(i)[3].evidence?.hasSuffix("\nHRV 7일 평균 27(좋음) · 4주 평균 25ms") == true)
    }
