...
extension FormPhase.Result {
    static func stub(early: FormPhase.Early? = nil, mid: FormPhase.Mid? = nil, late: FormPhase.Late,
                     ...
                     lateStats: FormPhase.PhaseStats? = nil) -> FormPhase.Result {
        ...
        let lateStatsResolved = lateStats ?? zeroed(startKm: lateStart, endKm: total)
        ...
        return FormPhase.Result(early: early, mid: mid, late: late,
                                ...
                                phases: FormPhase.Phases(early: earlyStats, mid: midStats, late: lateStatsResolved),
