...
## 구현 중 변경 (2026-09-22, 코드가 기준)

- **Task 1 픽스처**: 계획서의 `steadyRuns()`(27…1일)는 만성 4주 창의 28…34일 주가 비어 평소 부하가 1.33(>1.3)으로 급증 판정됐다. `[34, 32, 29, …, 1]`로 늘렸고, 연속 4일·2일 전 고강도 테스트의 끼워 넣는 러닝은 20분으로 줄여 급증·상승 문턱 아래에 뒀다. `mrDurationAcuteChronic`는 4주 중 러닝 있는 주가 3 미만이면 `ratio = nil`.
