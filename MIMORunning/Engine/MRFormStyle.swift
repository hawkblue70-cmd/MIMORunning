...
///   관측 지표가 2개 이상이고 그중 **실증(MDC 초과 또는 4주+ 연속) 변화가 1개 이상**일 때 말한다.
///   실증이 없으면 침묵 — 안정은 기본 상태다. (2026-08-31 fa60426에서 "두 지표 일치"에서 완화.
///   케이던스·지면접촉이 함께 실증이면 공중 시간으로 묶은 한 문단, 그 외는 지표마다 2줄.)
/// - Parameters:
