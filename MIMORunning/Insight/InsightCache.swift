...
actor InsightCache {
    ...
    private static let cacheVersion = 24   // 이지런 심박 우선 재분류 — 유형이 바뀐 러닝의 제목 재계산 (v23: AI 부연 주장 검사 — 원문에 없는 "가장·이번 달·연속" 폐기 (v22: 심박 비교를 15°C 기준으로 · v21: 이 러닝 이전 기록만 · v20: 직전 날짜 · v19–16: 이지런·AI 검사)
